...
class SiliconFlowEmbeddingClient:
    def __init__(self, api_key: str, base_url: str = "https://api.siliconflow.com/v1/embeddings"):
    ...
    def generate_embeddings(self, texts: List[str], model: str = "BAAI/bge-large-zh-v1.5") -> EmbeddingResult:
...
class EmbeddingSystem:
    """
    High-level embedding system that manages embedding generation and caching.
    
    This system provides a unified interface for embedding generation with
    caching, batching, and error handling capabilities.
    """
    ...
    def _generate_batch_embeddings(self, texts: List[str]) -> List[List[float]]:
        ...
        for attempt in range(self.max_retries):
            try:
                result = self.client.generate_embeddings(texts, self.embedding_model)
